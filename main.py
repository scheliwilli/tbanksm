...
# print(map)
date = datetime.fromisoformat("2026-04-05T21:00:00+01:00")
lst1 = map.get_min_duration("Москва", "Санкт-Петербург", date, transport_list=[1, 4])
print(*lst1)
...
lst4 = map.get_straight_races("Москва", "Санкт-Петербург", date, transport_list=[1, 2, 3])
