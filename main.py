...
# print(map)
date = datetime.strptime("01.11.2027 00:00", "%d.%m.%Y %H:%M")
...
lst3 = map.get_min_cost("Moscow", "Vladivostok", date, transport_list=[])
lst4 = map.get_straight_races("Moscow", "Vladivostok", date, transport_list=[1, 2, 3])
